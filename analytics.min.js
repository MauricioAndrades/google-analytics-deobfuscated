...
// original version (unminified) of analytics.js
(function () {
    var n = this || self;
            ...
            if (a.hasOwnProperty(c)) {
                ...
                if (void 0 !== d && d === d && null !== d && "[object Object]" !== d.toString()) {
                    ...
                    for (var h = [], g = 0; g < d.length; g += 3) {
                        ...
                        var t = k ? d.charCodeAt(g + 1) : 0;
                        var x = m ? d.charCodeAt(g + 2) : 0;
                        var ra = l >> 2;
                        l = ((l & 3) << 4) | (t >> 4);
                        t = ((t & 15) << 2) | (x >> 6);
                        x &= 63;
...
(function () {
    ...
    var O = window;
    var M = document;
    var jf = document.currentScript ? document.currentScript.src : "";
    ...
    var Le = S("up", "up");
    var Qe = S("_tac", void 0, !1);
    var Se = T("_gbraid");
    var Te = T("_gbt");
    var bf = T("_gbe", void 0, 7776e6);
    ...
    var Fd = function (a) {
        return function (b) {
            if ("pageview" == b.get(Va) && !a.I) {
                a.I = !0;
                var c = aa(b);
                var d = 0 < E(P(b, kb), "gclid").length;
                var e = 0 < E(P(b, kb), "wbraid").length;
                (c || d || e) &&
                    gc(function (g) {
                        c && a.send("timing", g);
